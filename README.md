...
#> paste(NULL, italic("F")["Fisher"], "(", "2", ",", "147", ") = ", 
#>     "119.26", ", ", italic("p"), " = ", "1.67e-31", ", ", widehat(omega["p"]^2), 
