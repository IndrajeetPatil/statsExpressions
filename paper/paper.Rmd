...
```{r grouped_df, echo=FALSE, eval=FALSE}
...
```{r anova_example, fig.cap="Example illustrating how `statsExpressions` functions can be used to display results from a statistical test in a plot."}
