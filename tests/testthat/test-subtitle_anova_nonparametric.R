...
testthat::test_that(
  ...
  code = {
    ...
    set.seed(123)
    using_function1 <-
      statsExpressions::subtitle_anova_nonparametric(
    ...
    set.seed(123)
    using_function2 <-
      suppressWarnings(statsExpressions::subtitle_anova_nonparametric(
        data = ggplot2::msleep,
        x = vore,
        y = sleep_cycle,
        k = 3,
...
testthat::test_that(
  ...
  code = {
    ...
    # ggstatsplot output
    set.seed(123)
    using_function1 <- statsExpressions::subtitle_anova_nonparametric(
    ...
    # ggstatsplot output
    set.seed(123)
    using_function2 <- statsExpressions::subtitle_anova_nonparametric(
      data = iris_long,
      x = condition,
      y = "value",
      k = 3,
