...
testthat::test_that(
  ...
  code = {
    ...
    set.seed(123)
    using_function <-
      statsExpressions::subtitle_mann_nonparametric(
...
testthat::test_that(
  ...
  code = {
    ...
    # expect error
    testthat::expect_error(suppressWarnings(statsExpressions::subtitle_mann_nonparametric(
      data = iris,
      x = Sepal.Length,
      y = Species
    )))
    ...
    set.seed(123)
    using_function2 <-
      suppressWarnings(statsExpressions::subtitle_mann_nonparametric(
        data = df_bird,
        x = type,
        y = length,
        k = 5,
