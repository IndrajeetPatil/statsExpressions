...
---
    ...
    Output
      expression(list(
      chi["Pearson"]^2*'('*2*')'=='8.74073', italic(p)=='0.01265',
      widehat(italic("V"))["Cramer"]=='0.46431', CI['99%']~'['*'0.00000', '1.00000'*']',
      italic("n")["obs"]=='32'))
...
---
    ...
    Output
      expression(list(
      chi["Pearson"]^2*'('*1*')'=='456.87', italic(p)=='2.30e-101',
      widehat(italic("V"))["Cramer"]=='0.46', CI['95%']~'['*'0.42', '1.00'*']',
      italic("n")["obs"]=='2,201'))
...
---
    ...
    Code
      unlist(df3$expression[[1]])
    Output
      expression(list(
      chi["Pearson"]^2*'('*15*')'=='15.75', italic(p)=='0.40',
      widehat(italic("V"))["Cramer"]=='0.06', CI['99%']~'['*'0.00', '1.00'*']',
      italic("n")["obs"]=='52'))
...
---
    ...
    Output
      expression(list(
      chi["McNemar"]^2*'('*1*')'=='13.33333', italic(p)=='0.00026',
      widehat(italic("g"))["Cohen"]=='0.33333', CI['95%']~'['*'0.16436', '0.42663'*']',
      italic("n")["pairs"]=='100'))
...
---
    ...
    Output
      expression(list(
      chi["McNemar"]^2*'('*1*')'=='13.333', italic(p)=='2.607e-04',
      widehat(italic("g"))["Cohen"]=='0.333', CI['90%']~'['*'0.195', '0.416'*']',
      italic("n")["pairs"]=='95'))
...
---
    ...
    Output
      expression(list(
      chi["gof"]^2*'('*1*')'=='1.12500', italic(p)=='0.28884',
      widehat(italic("C"))["Pearson"]=='0.18429', CI['99%']~'['*'0.00000', '1.00000'*']',
      italic("n")["obs"]=='32'))
...
---
    ...
    Output
      expression(list(
      chi["gof"]^2*'('*1*')'=='722.45', italic(p)=='3.92e-159',
      widehat(italic("C"))["Pearson"]=='0.50', CI['95%']~'['*'0.47', '1.00'*']',
      italic("n")["obs"]=='2,201'))
...
---
    ...
    Output
      expression(list(
      chi["gof"]^2*'('*3*')'=='33.76', italic(p)=='2.23e-07',
      widehat(italic("C"))["Pearson"]=='0.55', CI['95%']~'['*'0.41', '1.00'*']',
      italic("n")["obs"]=='76'))
...
# bayes factor (contingency tab)
    ...
    Code
      list(unlist(expr_text1$expression[[1]]), unlist(expr_text2$expression[[1]]),
