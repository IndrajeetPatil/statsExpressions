...
---
    ...
    Output
      [[1]]
      list(log[e] * (BF["01"]) == "2.139", widehat(italic(R^"2"))["Bayesian"]^"posterior" == 
          "0.000", CI["95%"]^HDI ~ "[" * "0.000", "0.078" * "]", italic("r")["Cauchy"]^"JZS" == 
          "0.990")
...
---
    ...
    Output
      [[1]]
      list(log[e] * (BF["01"]) == "-65.0969", widehat(italic(R^"2"))["Bayesian"]^"posterior" == 
          "0.6118", CI["99%"]^HDI ~ "[" * "0.5107", "0.6789" * "]", 
          italic("r")["Cauchy"]^"JZS" == "0.7070")
