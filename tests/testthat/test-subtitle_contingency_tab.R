...
testthat::test_that(
  ...
  code = {
    ...
    set.seed(123)
    using_function1 <-
      suppressWarnings(statsExpressions::subtitle_contingency_tab(
    ...
    # with counts
    set.seed(123)
    using_function2 <- statsExpressions::subtitle_contingency_tab(
...
testthat::test_that(
  ...
  code = {
    ...
    using_function1 <-
      suppressWarnings(
        statsExpressions::subtitle_contingency_tab(
          data = paired_data,
          x = "response_before",
          y = response_after,
          paired = TRUE,
...
testthat::test_that(
  ...
  code = {
    ...
    # ggstatsplot output
    set.seed(123)
    subtitle1 <- suppressWarnings(statsExpressions::subtitle_contingency_tab(
      data = df,
      x = Var1,
      y = Var2,
      counts = "Freq",
...
testthat::test_that(
  ...
  code = {
    ...
    set.seed(123)
    using_function1 <-
      statsExpressions::subtitle_onesample_proptest(
        data = mtcars,
        x = "am",
        legend.title = "Engine",
        conf.level = 0.99,
