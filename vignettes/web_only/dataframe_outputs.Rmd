...
A dataframe will typically contain the following columns (the exact details
depend on the test and statistical approach):
  ...
  - *ci.width*: width of the confidence interval.
