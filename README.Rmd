...
[![Total downloads](https://cranlogs.r-pkg.org/badges/grand-total/statsExpressions?color=blue)](https://CRAN.R-project.org/package=statsExpressions)
...
#| echo = FALSE,
#| out.width = "80%",
#| fig.alt = "Diagram showing the general workflow of the statsExpressions package"
...
```{r}
#| label = "centrality",
#| fig.alt = "Example ggplot showing centrality_description output: mean wt by cyl with labeled statistical expressions."
...
```{r}
#| label = "anova_rob1",
#| fig.alt = "Example ridge density plot for a heteroscedastic one-way ANOVA on Sepal.Length by Species"
...
#| fig.alt = "Quasirandom dot plot of wine taste ratings by wine type with Friedman's rank sum test subtitle"
...
```{r}
#| label = "t_two",
#| fig.alt = "Boxplot of ToothGrowth data with Two-Sample Welch's t-test expression in the subtitle"
...
```{r}
#| label = "t_two_paired1",
#| fig.alt = "Example paired profiles plot for a two-sample Wilcoxon paired test"
...
```{r}
#| label = "t_one",
#| fig.alt = "Histogram of car weights with a vertical line at the mean and Bayesian one-sample t-test subtitle"
...
```{r}
#| label = "corr",
#| fig.alt = "Scatterplot of car fuel efficiency (mpg) versus weight (wt) with linear fit and Spearman correlation expression"
...
```{r}
#| label = "gof",
#| fig.alt = "Pie chart of car classes showing example output with statistical caption"
...
#| fig.height = 14,
#| fig.width = 12,
#| fig.alt = "Meta-analysis forest plot of the Mozart effect example, showing study estimates and the overall random-effects result."
...
```{r}
#| label = "custom_expr",
#| fig.alt = "Example ggplot boxplot of iris Sepal.Length by Species with a custom statistical expression subtitle"
