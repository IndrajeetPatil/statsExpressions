...
- to provide a consistent syntax to do statistical analysis with tidy data,
- to provide statistical expressions (i.e., a pre-formatted in-text statistical
result) for plotting functions.

Currently, it supports common types of statistical approaches and
