...
produces dataframes with rich details for the most common types of statistical
...
> Patil, I., (2021). statsExpressions: R Package for Tidy
  Dataframes and Expressions with Statistical Details. Journal
  of Open Source Software, 6(59), 3111.
  https://doi.org/10.21105/joss.03111

If you wish to get a BibTeX entry for LaTeX, you can use the following function:
...
These functions also play nicely with `dplyr` function. For example, let's say
we want to run a one-sample *t*-test for all levels of a certain grouping
variable. Here is how you can do it:
