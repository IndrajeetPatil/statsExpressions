...
#' statsExpressions::subtitle_corr_test(
...
# function body
subtitle_corr_test <- function(data,
                               x,
                               y,
                               nboot = 100,
                               beta = 0.1,
...
#' @name subtitle_corr_test
#' @aliases  subtitle_corr_test
#' @export

subtitle_ggscatterstats <- subtitle_corr_test
